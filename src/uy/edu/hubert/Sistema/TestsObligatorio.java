...
public class TestsObligatorio {
	...
	public void testListarUsuarios() {
		...
		assertEquals(Retorno.Resultado.OK, retorno.resultado);
		assertEquals(
				"AAA1111@gmail.com;Omar|BBB1111@gmail.com;Jorge|CAP1891@gmail.com;Nicolas|FFF1111@gmail.com;Ximena|TTT1111@gmail.com;Analia|UUU1111@gmail.com;Maria",
				retorno.valorString);
	}
	...
	public void testRegistrarDeliveryError2() {
		...
		sistema.inicializarSistema(10);
		assertEquals(Retorno.Resultado.OK, sistema.registrarDelivery("001", 1.0, 1.0).resultado);
		assertEquals(Retorno.Resultado.ERROR_2, sistema.registrarDelivery("002", 1.0, 1.0).resultado); // mismas
																										// coordenadas
	}
	...
	public void testRegistrarMovilError2() {
		...
		sistema.inicializarSistema(10);
		assertEquals(Retorno.Resultado.OK, sistema.registrarMovil("001", 1.0, 1.0).resultado);
		assertEquals(Retorno.Resultado.ERROR_2, sistema.registrarMovil("002", 1.0, 1.0).resultado); // mismas
																									// coordenadas
	}
